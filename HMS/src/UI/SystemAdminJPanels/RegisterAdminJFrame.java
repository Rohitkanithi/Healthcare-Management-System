 ...
 * @author Rohit
 */
public class RegisterAdminJFrame extends javax.swing.JFrame {

    /**
     * Creates new form RegisterAdminJFrame
     */
    public RegisterAdminJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterAdminJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterAdminJFrame().setVisible(true);
            }
        });
    }
